#include "$CurrentDir:\\mpmissions\\Expansion.rostow\\expansion\\ExpansionObjectSpawnTools.c"
#include "$CurrentDir:\\mpmissions\\Expansion.rostow\\expansion\\missions\\MissionConstructor.c"
...
void main()
{
	...
	Print(loadTraderObjects);
	Print(loadTraderNPCs);
